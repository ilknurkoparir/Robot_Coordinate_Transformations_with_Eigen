...
Nokta bulutları,  **birbirinden bağımsız** ve sensöre göre konumlandırılmış olarak görünmekte; UAV'ın gerçek uzaydaki konumu yansıtılmamaktadır.
...
Nokta bulutları, **aynı referans sisteminde** hizalanmış olup UAV'ın gerçek uçuş yolu ve ortamın 3B yapısı gözlemlenebilmektedir.
